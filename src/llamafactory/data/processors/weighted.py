...
def preprocess_weighted_supervised_dataset(
    ...
    for i in range(len(examples["_prompt"])):
        ...
        input_ids, labels, weight = _encode_supervised_example(
            prompt=examples["_prompt"][i],
            response=examples["_response"][i],
            system=examples["_system"][i],
            weight=examples["_weight"][i],
        ...
        model_inputs["weight"].append(weight)
...
def print_weighted_supervised_dataset_example(example: Dict[str, List[int]], tokenizer: "PreTrainedTokenizer") -> None:
