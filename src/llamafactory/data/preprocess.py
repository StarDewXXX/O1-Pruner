...
from .processors.weighted import (
    preprocess_weighted_supervised_dataset,
    print_weighted_supervised_dataset_example
)
...
def get_preprocess_and_print_func(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "kto","wsft"],
    template: "Template",
    ...
    if stage == "pt":
    ...
    elif (stage == "sft" or stage == "wsft") and not do_generate:
        if data_args.packing:
            ...
            if stage == "wsft":
                # print("******load wsft preprocess_func******" )
                preprocess_func = partial(
                    preprocess_weighted_supervised_dataset,
                    template=template,
                    tokenizer=tokenizer,
        ...
        if stage == "wsft":
            print_function = partial(print_weighted_supervised_dataset_example, tokenizer=tokenizer)
        else:
