...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    ...
    print("finetuning_args.stage:",finetuning_args.stage)

    if finetuning_args.stage == "pt":
        run_pt(model_args, data_args, training_args, finetuning_args, callbacks)
    elif finetuning_args.stage == "wsft":
        print("***********[running wsft]************")
        run_wsft(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
