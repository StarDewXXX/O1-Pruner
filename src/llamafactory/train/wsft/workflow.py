...
def run_wsft(
    ...
    dataset_module = get_dataset(template, model_args, data_args, training_args, stage="wsft", **tokenizer_module)
    model = load_model(tokenizer, model_args, finetuning_args, training_args.do_train)
    ref_model = load_model(tokenizer, model_args, finetuning_args, training_args.do_train)
